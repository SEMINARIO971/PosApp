<nav x-data="{ open: false }" class="bg-[#0d0d0d] dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link class="text-white" :href="route('clientes')" :active="request()->routeIs('clientes')">
                        {{ __('clientes') }}
                    </x-nav-link>
                </div>
            </div>
