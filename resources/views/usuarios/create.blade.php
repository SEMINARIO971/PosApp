...
<div class="container mx-auto p-6">
    ...
    <form action="{{ route('users.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="flex justify-end">
            <a href="{{ route('usuarios.index') }}" class="mr-4 inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">Regresar</a>
